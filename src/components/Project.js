    ...
    <div className='flex flex-col-reverse gap-20 mt-12 sm:flex-row sm:items-center sm:justify-between'>
        <div className='w-full sm:w-1/2'>
            <div className='flex flex-col gap-2'>
                <h1 className='text-xl font-bold text-[#ffae00]'>{name}</h1>
...
//<a href={live} target='_blank' rel='noreferrer' className='flex items-center bg-[#ffae00] text-white px-4 py-2 rounded-md text-sm'>
//Demo
//</a>